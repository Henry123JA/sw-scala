  ...
  <AppLayout>
    <div class="max-w-2xl space-y-6">
      <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-800">Nuevo Alumno</h1>
      ...
      <form @submit.prevent="submit" class="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p v-if="form.errors.referido_por" class="mt-1 text-xs text-red-600">{{ form.errors.referido_por }}</p>
          </div>
        </div>
