  ...
  <AppLayout>
    <div class="max-w-2xl space-y-6">
      <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-800">Nuevo Curso</h1>
      ...
      <form @submit.prevent="submit" class="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700">Tipo de Enseñanza (ej. Instrumento, Canto, Teoría)</label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700">Duración Estándar (ej. 3 meses, 1 año)</label>
