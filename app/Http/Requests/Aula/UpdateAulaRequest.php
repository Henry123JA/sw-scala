...
class UpdateAulaRequest extends FormRequest
{
    ...
    {
        // Get the route parameter 'aula', which could be an ID or model instance depending on binding
        ...
        return [
            'nombre' => [
                ...
                'string',
                'max:100',
                Rule::unique('sala')->ignore($aulaId)->where(fn ($q) => $q->where('eliminado', false))
            ],
